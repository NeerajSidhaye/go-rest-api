...
func main() {
	...
	logger := log.New(os.Stdout, "Shoe Prodcut API: " , log.LstdFlags)
	...
	// registers product handler to serve request on url "/getProducts".
	// this is simple http webservice hence you see the url has 'get' in it "/getProducts"
	servMux.Handle("/getProducts", productHandler) 
